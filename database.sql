...
CREATE TABLE table_three(user_id INT(10) PRIMARY KEY UNIQUE, user_name VARCHAR(100), user_email VARCHAR(200));
INSERT INTO table_three VALUES(1,'Felipa Trantow','gschaden@yahoo.com');
COMMIT;
